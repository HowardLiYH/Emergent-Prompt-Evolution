...
\begin{enumerate}[leftmargin=*,topsep=2pt,itemsep=4pt]
    ...
    \item \textbf{Practical benefit demonstration} showing that evolved specialists achieve the theoretical ceiling (100\% on matched tasks), with oracle routing unlocking +64.2\% $\pm$ 2.3\% improvement and 5--7 task break-even (Section~\ref{sec:realworld}).
\end{enumerate}
