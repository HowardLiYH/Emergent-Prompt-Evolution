...
\toprule
\textbf{Routing Strategy} & \textbf{How It Works} & \textbf{Accuracy} \\
\midrule
Random assignment & Pick any specialist randomly & 35.8\% \\
\textbf{Oracle routing} & \textbf{Always pick the correct specialist} & \textbf{100\%} \\
Confidence routing & Pick the most confident specialist & 41.7\% \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Why use ``oracle''?} Because in the real world, we don't automatically know which specialist to use. Oracle routing is a \textit{theoretical upper bound}---it shows the maximum possible benefit if we had perfect task classification.

\textbf{The +64.2\% practical benefit} = Oracle routing (100\%) $-$ Random assignment (35.8\%) = 64.2\% improvement.

This metric answers: ``If we could perfectly route tasks to specialists, how much would we gain?''
\end{remark}
...
\subsubsection{What Is Power Analysis? (Section 32.4 Explained)}
...
\subsubsection{What Is Holm-Bonferroni Correction? (Section 32.3 Explained)}
