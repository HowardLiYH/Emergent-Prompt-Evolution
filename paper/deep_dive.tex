...
\begin{tikzpicture}[scale=0.8]
    ...
    \begin{scope}[xshift=0cm]
        \draw[->] (0,0) -- (4.5,0) node[right, font=\small] {conf};
        \draw[->] (0,0) -- (0,2.5) node[above, font=\small] {$P$};
        \draw[blue, thick, domain=0.5:3.5, samples=50] plot (\x, {1.5*exp(-0.5*(\x-2)^2)});
        \node[below, font=\small] at (2, -0.3) {L0: wide, uncertain};
        \draw[dashed] (2,0) -- (2,1.5);
        \node[font=\scriptsize] at (2, -0.7) {mean $\approx$ 50\%};
    \end{scope}
    ...
    \begin{scope}[xshift=7cm]
        \draw[->] (0,0) -- (4.5,0) node[right, font=\small] {conf};
        \draw[->] (0,0) -- (0,2.5) node[above, font=\small] {$P$};
        \draw[red, thick, domain=2.5:4, samples=50] plot (\x, {2.2*exp(-2*(\x-3.5)^2)});
        \node[below, font=\small] at (2, -0.3) {L3: narrow, confident};
        \draw[dashed] (3.5,0) -- (3.5,2.2);
        \node[font=\scriptsize] at (2, -0.7) {mean $\approx$ 90\%};
    \end{scope}
\end{tikzpicture}
\end{center}
